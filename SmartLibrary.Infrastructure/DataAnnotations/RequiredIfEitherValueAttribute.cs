//-----------------------------------------------------------------------
// <copyright file="RequiredIfEitherValueAttribute.cs" company="Caspian Pacific Tech">
...
namespace SmartLibrary.Infrastructure.DataAnnotations
{
    ...
    /// </summary>
    public class RequiredIfEitherValueAttribute : RequiredAttribute, IClientValidatable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredIfEitherValueAttribute" /> class.
        /// </summary>
        ...
        public RequiredIfEitherValueAttribute(string property1, string[] values1, string property2, string[] values2)
        {
